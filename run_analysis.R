...
names(test.data.frame) = c("subject", "activity", "set.mean", "set.standard.deviation", "body.acceleration.x.mean", "body.acceleration.x.standard.deviation", "body.acceleration.y.mean", "body.acceleration.y.standard.deviation", "body.acceleration.z.mean", "body.acceleration.z.standard.deviation", "body.gyroscope.x.mean", "body.gyroscope.x.standard.deviation", "body.gyroscope.y.mean", "body.gyroscope.y.standard.deviation", "body.gyroscope.z.mean", "body.gyroscope.z.standard.deviation", "total.acceleration.x.mean", "total.acceleration.x.standard.deviation", "total.acceleration.y.mean", "total.acceleration.y.standard.deviation", "total.acceleration.z.mean", "total.acceleration.z.standard.deviation")
